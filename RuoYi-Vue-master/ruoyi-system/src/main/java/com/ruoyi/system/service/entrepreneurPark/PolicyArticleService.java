...
public interface PolicyArticleService extends IService<PolicyArticle> {
    ...
    Page<PolicyArticleVO> getPolicyArticles1(int page, int size,String categoryName,String tagName);
    ...
    String addPolicyArticleImg(MultipartFile file) throws IOException;

    Page<PolicyArticleVO> getEnterpriseCategoryArticles(int page, int size, String enterpriseName);
}
